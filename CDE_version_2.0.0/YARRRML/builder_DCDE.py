...
["this:$(pid)_$(uniqid)_Process","sio:SIO_000230","this:$(pid)_$(uniqid)_$(inputLabel)","iri","this:$(context_id)_Context"],
["this:$(pid)_$(uniqid)_Process","sio:SIO_000291","this:$(pid)_$(uniqid)_$(targetLabel)","iri","this:$(context_id)_Context"],
["this:$(pid)_$(uniqid)_Output","sio:SIO_000628","this:$(pid)_$(uniqid)_Attribute","iri","this:$(context_id)_Context"],
["this:$(pid)_$(uniqid)_Output","sio:SIO_000221","this:$(pid)_$(uniqid)_$(unitLabel)","iri","this:$(context_id)_Context"],
...
["this:$(pid)_$(uniqid)_$(inputLabel)","rdf:type","sio:SIO_000015","iri","this:$(context_id)_Context"],
["this:$(pid)_$(uniqid)_$(inputLabel)","rdf:type","$(inputURI)","iri","this:$(context_id)_Context"],
["this:$(pid)_$(uniqid)_$(targetLabel)","rdf:type","sio:SIO_000015","iri","this:$(context_id)_Context"],
["this:$(pid)_$(uniqid)_$(targetLabel)","rdf:type","$(targetURI)","iri","this:$(context_id)_Context"],
...
["this:$(pid)_$(uniqid)_$(unitLabel)","rdf:type","sio:SIO_000074","iri","this:$(context_id)_Context"],
["this:$(pid)_$(uniqid)_$(unitLabel)","rdf:type","$(unitURI)","iri","this:$(context_id)_Context"],
...
["this:$(pid)_$(uniqid)_$(inputLabel)","rdfs:label","Input: $(inputLabel)","xsd:string","this:$(context_id)_Context"],
["this:$(pid)_$(uniqid)_$(targetLabel)","rdfs:label","Target: $(targetLabel)","xsd:string","this:$(context_id)_Context"],
["this:$(pid)_$(uniqid)_Attribute","rdfs:label","$(model) attribute","xsd:string","this:$(context_id)_Context"],
["this:$(pid)_$(uniqid)_$(unitLabel)","rdfs:label","$(unitLabel) unit","xsd:string","this:$(context_id)_Context"],
...
["this:$(pid)_$(uniqid)_Output","sio:SIO_000300","$(valueInput)","xsd:integer","this:$(context_id)_Context"],
